...
///*************************************************************************************
//Name:  output
//Precondition: everything is initialized
//Postcondition: evertything is printied to data file
//Description:  print data to output file
//*************************************************************************************
...
void output(ofstream & out, const order_record & p_record)
{
	...
	out.setf(ios::fixed);
	/********************************************/
	out << p_record.cell_number << "\t"<<p_record.item_number<< "\t"<<p_record.quantity<< "\t"<<p_record.price<< "\t"<<p_record.processing_plant<< "\t"<<p_record.tax_rate<< "\t"<<p_record.order_tax<< "\t"<<p_record.net_cost<< "\t"<<p_record.total_cost<<endl;
...
int main()
{
	...
	out.open("amazon_inventory_092019.txt");
